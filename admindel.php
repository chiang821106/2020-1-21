        ...
        <form name="form1" method="post" action="">
            <table border="0" align="center" class="table table-success table-striped" style="max-width:1200px;" cellpadding="4" cellspacing="0">
                ...
                <tr valign="top">
                    <td>
                        <p>
                            <strong>姓名</strong>：<?php echo $row["boardname"]; ?>&nbsp;&nbsp;&nbsp;
                            <strong>性別</strong>：<?php echo $row["boardsex"]; ?>
                        </p>
                        <p>
                            <strong>標題</strong>：<?php echo $row["boardsubject"]; ?>
                        </p>
                        <p>
                            <strong>內容</strong>：<?php echo nl2br($row["boardcontent"]); ?>
                        </p>
                    </td>
                </tr>
                <tr valign="top">
